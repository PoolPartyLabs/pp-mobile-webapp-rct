...
export type AutoLayoutVertical6Type = {
  className?: string;
};

const AutoLayoutVertical6: FunctionComponent<AutoLayoutVertical6Type> = ({
  className = "",
}) => {
  return (
    <section
      className={`w-[375px] h-[442px] shadow-[0px_1px_2px_rgba(10,_13,_20,_0.03)] flex flex-col items-start justify-start text-left text-font-size-paragraph text-text-sub-600 font-Web-title-1-normal ${className}`}
    >
      ...
      <div className="self-stretch rounded-t-none rounded-b-radius-24 bg-bg-white-0 border-gray border-solid border-r-[1px] border-b-[1px] border-l-[1px] flex flex-col items-start justify-start pt-0 px-0 pb-3.5 gap-spacing-spacing-16">
        <div className="w-[376px] overflow-hidden flex flex-col items-start justify-start pt-spacing-spacing-32 px-spacing-spacing-16 pb-0 box-border gap-spacing-spacing-32">
          ...
          <div className="flex flex-row items-start justify-start gap-spacing-spacing-8">
            <div className="h-[150px] w-[200px] shadow-[0px_1px_2px_rgba(10,_13,_20,_0.03)] rounded-radius-16 bg-bg-white-0 border-stroke-soft-200 border-solid border-[0.5px] box-border overflow-hidden shrink-0 flex flex-col items-start justify-between p-spacing-spacing-16 gap-0">
            ...
            <div className="h-[150px] w-[200px] shadow-[0px_1px_2px_rgba(10,_13,_20,_0.03)] rounded-radius-16 border-stroke-soft-200 border-solid border-[0.5px] box-border overflow-hidden shrink-0 flex flex-col items-start justify-between p-spacing-spacing-16 relative gap-0">
...
export default AutoLayoutVertical6;
