...
const OnboardHomeContent: FunctionComponent<OnboardHomeContentType> = ({
  ...
  return (
    <div
      className={`w-[375px] rounded-t-[28px] bg-[#171717] overflow-hidden flex flex-col items-center justify-start p-spacing-spacing-32 gap-spacing-spacing-40 z-[1] relative text-left text-[26px] text-[#fff] font-Web-title-1-normal ${className}`}
    >
      ...
      <div className="w-full flex flex-col items-start justify-start gap-spacing-spacing-14 text-[14px] text-[#656565]">
        ...
        <SkipButton navigateTo="/" />
      </div>
      <StepperDot11 size="Small" state={0} />
    </div>
  )
}
